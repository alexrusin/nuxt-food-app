<template>
  <main class="container cart">
    <div v-if="itemsInCart === 0" class="emptyCartWrapper">
      <h2>Your Cart</h2>
      <svg
        height="100px"
        width="100px"
      ...
      <!-- <button class="primary" @click="$router.push('/restaurants')">
        Fill it up
      </button> -->
    </div>
    <table v-else>
